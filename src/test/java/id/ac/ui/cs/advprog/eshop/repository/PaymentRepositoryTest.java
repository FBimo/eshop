...
public class PaymentRepositoryTest {
    ...
    void setUp(){
        ...
        Payment payment1 = new Payment("ABCDE", PaymentMethod.PAYMENT_BY_BANK_TRANSFER.getValue(), PaymentStatus.SUCCESS.getValue(), new HashMap<>());
        Payment payment2 = new Payment("23456", PaymentMethod.PAYMENT_BY_BANK_TRANSFER.getValue(), PaymentStatus.SUCCESS.getValue(), new HashMap<>());
        Payment payment3 = new Payment("901234", PaymentMethod.PAYMENT_BY_BANK_TRANSFER.getValue(), PaymentStatus.SUCCESS.getValue(), new HashMap<>());
        Payment payment4 = new Payment("xyzabc", PaymentMethod.PAYMENT_BY_BANK_TRANSFER.getValue(), PaymentStatus.SUCCESS.getValue(), new HashMap<>());
        Payment payment5 = new Payment("defghij", PaymentMethod.PAYMENT_BY_BANK_TRANSFER.getValue(), PaymentStatus.SUCCESS.getValue(), new HashMap<>());
